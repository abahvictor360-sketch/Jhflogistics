...
export default function NotFound() {
  return (
    <section className="container-x py-28 text-center">
      <p className="text-sm font-bold uppercase tracking-[0.2em] text-brand-ink">404</p>
      ...
      <div className="mt-8 flex justify-center gap-3 text-sm font-semibold">
        <Link href="/" className="rounded-full bg-brand-ink px-6 py-3 text-white transition hover:bg-brand-dark">
          Back To Home
        </Link>
